...
print(
    'NOTE: "predicted" wrench values are not accurate due to the foot saturation '
    "and as such they are not checked."
)
print(
    "CoP values are predicted under the assumption that they are at the foot border "
    "and as such they are checked."
)
...
copLeft = [
    ...
    distribute_conf.RIGHT_FOOT_SIZES[3],
    0.0,
]
...
copRight = [
    ...
    distribute_conf.RIGHT_FOOT_SIZES[2],
    0.0,
]
