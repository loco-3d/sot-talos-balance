...
dummy.com.value = np.array([1.0] * 3)
dummy.momenta.value = np.array([2.0] * 3)
...
assert_almost_equal(dummy.dcm.value, np.array([3.0] * 3))

dummy.momenta.value = np.array([3.0] * 6)
dummy.dcm.recompute(1)
print(dummy.dcm.value)
assert_almost_equal(dummy.dcm.value, np.array([4.0] * 3))
