...
// void pointRotationByQuaternion(const Eigen::Vector3d & point,const Eigen::Vector4d & quat, Eigen::Vector3d &
// rotatedPoint);
...
class TALOS_BASE_ESTIMATOR_EXPORT TalosBaseEstimator : public ::dynamicgraph::Entity {
 ...
 public:
  ...
  void kinematics_estimation(const Vector6& ft, const Vector6& K, const SE3& oMfs, const pinocchio::FrameIndex foot_id,
