...
plug(robot.distribute.ankleWrenchLeft, robot.leftPitchSelec.sin)
...
# plug(robot.leftPitchSelec.sout, controller.tauDes)
...
robot.stateselecLR = Selec_of_vector("stateselecLR")
...
plug(robot.distribute.ankleWrenchLeft, robot.leftRollSelec.sin)
...
# plug(robot.leftRollSelec.sout, controller.tauDes)
...
create_topic(
    robot.publisher,
    robot.rightPitchAnkleController,
    "tau",
    robot=robot,
    data_type="vector",
)
...
create_topic(
    robot.publisher,
    robot.rightRollAnkleController,
    "tau",
    robot=robot,
    data_type="vector",
)
...
create_topic(
    robot.publisher,
    robot.leftPitchAnkleController,
    "tau",
    robot=robot,
    data_type="vector",
)
