...
robot.halfSitting = [0.0, 0.0, 1.018213, 0.0, 0.0, 0.0]  # Base
robot.halfSitting += [0.0, 0.0, -0.411354, 0.859395, -0.448041, -0.001708]  # Left Leg
robot.halfSitting += [0.0, 0.0, -0.411354, 0.859395, -0.448041, -0.001708]  # Right Leg
...
robot.halfSitting += [0.0, 0.0]  # Head
...
robot.hipComp = create_hip_flexibility_compensation(
    robot, hipFlexCompConfig, robot_name
)
...
create_topic(
    robot.publisher, robot.hipComp, "tau_filt", robot=robot, data_type="vector"
)
