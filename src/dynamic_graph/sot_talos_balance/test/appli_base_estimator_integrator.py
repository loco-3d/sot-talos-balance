...
robot.integrate.setVelocity(robot.dynamic.getDimension() * [0.0])
...
robot.delay_vel.setMemory(robot.dynamic.getDimension() * [0.0])
...
create_topic(
    robot.publisher, robot.imu_filters, "imu_quat", robot=robot, data_type="vector"
)

create_topic(
    robot.publisher, robot.base_estimator, "w_lf", robot=robot, data_type="double"
)
create_topic(
    robot.publisher, robot.base_estimator, "w_rf", robot=robot, data_type="double"
)
create_topic(
    robot.publisher,
...
create_topic(
    robot.publisher,
    robot.device_filters.ft_LF_filter,
    "x_filtered",
    robot=robot,
    data_type="vector",
)
...
create_topic(
    robot.publisher,
    robot.device_filters.ft_RF_filter,
    "x_filtered",
    robot=robot,
    data_type="vector",
)
...
create_topic(
    robot.publisher, robot.base_estimator, "lf_xyzquat", robot=robot, data_type="vector"
)
create_topic(
    robot.publisher, robot.base_estimator, "rf_xyzquat", robot=robot, data_type="vector"
)
