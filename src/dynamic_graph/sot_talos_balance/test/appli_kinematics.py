...
robot.contactLF.featureDes.velocity.value = [0.0] * 6
...
robot.contactRF.featureDes.velocity.value = [0.0] * 6
...
robot.taskRH.featureDes.velocity.value = [0.0] * 6
...
robot.taskLH.featureDes.velocity.value = [0.0] * 6
