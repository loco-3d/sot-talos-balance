...
forceRLEG_data = np.loadtxt(
    "/tmp/dg_" + evalCommandClient("robot.device.name") + "-forceRLEG.dat"
)
forceLLEG_data = np.loadtxt(
    "/tmp/dg_" + evalCommandClient("robot.device.name") + "-forceLLEG.dat"
)
